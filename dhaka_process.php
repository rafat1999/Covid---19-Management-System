...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
     ...
     $conn=mysqli_connect($servername,$username,$password,$database);
     $cheak_duplicate_entry = "SELECT hospital_name FROM dhaka WHERE  hospital_name = '$hospital_name'";
     ...
     if(!$conn){
         ...
         $sql="INSERT INTO `dhaka` (`hospital_name`,`oxyzen_level`,`bed_covid`,`icu_covid`,`contact`) VALUES ('$hospital_name','$oxyzen_level','$bed_covid','$icu_covid','$contact')";
