...
<body>
	<div class="container">
		<button class="btn btn-primary my-5"><a href="/Project/India.php" class="text-light">Add User</a></button>
<table class="table" >
  <thead>
    <tr>
...
$records = mysqli_query($db,"select * from india"); // fetch data from database
...
?>
  <tr>
    ...
    <td>
	<button class="btn btn-primary"><a href="india update.php? updateid=<?php echo $data['Country_Name']; ?>" class="text-light">Update</a></button>
	<button class="btn btn-danger"><a href="india delete.php? deleteid=<?php echo $data['Country_Name']; ?>" class="text-light">Delete</a></button>
</td>
  </tr>	
<?php
}
