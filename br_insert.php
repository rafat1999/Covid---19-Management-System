...
<html>
<head>
	<title>Barisal Devision</title>
</head>
<body style="background-image: url(IMG/bar02.jpg); background-repeat: no-repeat; background-size: cover;">
	<?php
	...
	?>
	<form action="process.php" method="POST" align="center" name="my_form" onsubmit="return validate()">
