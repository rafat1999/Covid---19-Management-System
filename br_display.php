...
<body>
	<div class="container">
		<button class="btn btn-primary my-5"><a href="/Project/br_insert.php" class="text-light">Add User</a></button>
<table class="table" >
  <thead>
    <tr>
...
?>
  <tr>
    ...
    <td>
	<button class="btn btn-primary"><a href="br_update.php? updateid=<?php echo $data['hospital_name']; ?>" class="text-light">Update</a></button>
	<button class="btn btn-danger"><a href="br_delete.php? deleteid=<?php echo $data['hospital_name']; ?>" class="text-light">Delete</a></button>
</td>
  </tr>	
<?php
}
