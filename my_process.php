...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
     ...
     $cheak_duplicate_entry = "SELECT hospital_name FROM mymenshing WHERE  hospital_name = '$hospital_name'";
     ...
     if(!$conn){
         ...
         $sql="INSERT INTO `mymenshing` (`hospital_name`,`oxyzen_level`,`bed_covid`,`icu_covid`,`contact`) VALUES ('$hospital_name','$oxyzen_level','$bed_covid','$icu_covid','$contact')";
