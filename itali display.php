...
<body>
	<div class="container">
		<button class="btn btn-primary my-5"><a href="/Project/Italian.php" class="text-light">Add User</a></button>
<table class="table" >
  <thead>
    <tr>
...
?>
  <tr>
    ...
    <td>
	<button class="btn btn-primary"><a href="itali update.php? updateid=<?php echo $data['Country_Name']; ?>" class="text-light">Update</a></button>
	<button class="btn btn-danger"><a href="itali delete.php? deleteid=<?php echo $data['Country_Name']; ?>" class="text-light">Delete</a></button>
</td>
  </tr>	
<?php
}
