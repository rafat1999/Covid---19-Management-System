...
<body style="background-image: url(IMG/itali1.jpg); background-repeat: no-repeat; background-size: cover;">
	<?php
	...
	?>
	<form action="Italy_process.php" method="POST" align="center" name="my_form" onsubmit="return validate()">
