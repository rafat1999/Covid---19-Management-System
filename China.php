...
<body style="background-image: url(IMG/pic14.jpg); background-repeat: no-repeat; background-size: cover;">
	<?php
	...
	?>
	<form action="china_process.php" method="POST" align="center" name="my_form" onsubmit="return validate()">
