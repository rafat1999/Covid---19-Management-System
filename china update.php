...
if(count($_POST)>0) {
mysqli_query($db,"UPDATE country set Country_Name='" . $_POST['Country_Name'] . "', Effected_People='" . $_POST['Effected_People'] . "', No_of_cured_people='" . $_POST['No_of_cured_people'] . "' ,Total_Numbers_of_Death='" . $_POST['Total_Numbers_of_Death'] . "' WHERE Country_Name ='" . $_POST['Country_Name'] . "'");
header("location:china display.php");
}
$result = mysqli_query($db,"SELECT * FROM country WHERE Country_Name='" . $_GET['updateid'] . "'");
