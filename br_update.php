...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE br_hos set hospital_name='" . $_POST['hospital_name'] . "', oxyzen_level='" . $_POST['oxyzen_level'] . "', bed_covid='" . $_POST['bed_covid'] . "' ,icu_covid='" . $_POST['icu_covid'] . "',contact='" . $_POST['contact'] . "' WHERE hospital_name='" . $_POST['hospital_name'] . "'");
header("location:br_display.php");
}
$result = mysqli_query($conn,"SELECT * FROM br_hos WHERE hospital_name='" . $_GET['updateid'] . "'");
