...
<html>
<head>
	<title>Mymenshing  Devision</title>
</head>
<body style="background-image: url(IMG/mym.jpg); background-repeat: no-repeat; background-size: cover;">
	<?php
	...
	?>
	<form action="my_process.php" method="POST" align="center" name="my_form" onsubmit="return validate()">
		<u><h1><ceter><font face="Time New Romans" size="10" color="black">Insert Data for Hospital</font></center></h1></u>
		<table align="center" border="2" width="60%" heigth="70px" bgcolor="white">
