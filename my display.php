...
<body>
	<div class="container">
		<button class="btn btn-primary my-5"><a href="/Project/my_insert.php" class="text-light">Add User</a></button>
<table class="table" >
  <thead>
    <tr>
...
$records = mysqli_query($conn,"select * from mymenshing"); // fetch data from database
...
?>
  <tr>
    ...
    <td>
	<button class="btn btn-primary"><a href="my update.php? updateid=<?php echo $data['hospital_name']; ?>" class="text-light">Update</a></button>
	<button class="btn btn-danger"><a href="my delete.php? deleteid=<?php echo $data['hospital_name']; ?>" class="text-light">Delete</a></button>
</td>
  </tr>	
<?php
}
