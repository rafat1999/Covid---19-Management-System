...
<body style="background-image: url(IMG/pic10.jpg); background-repeat: no-repeat; background-size: cover;">
	<?php
	...
	?>
	<form action="india_process.php" method="POST" align="center" name="my_form" onsubmit="return validate()">
  ...
  <script type="text/javascript">
    var info = document.getElementById('statesMenu');
    info.onchange = function()
    {
      var option = this.options[this.selectedIndex];
      if (option.value != "none") 
      {
        window.open(option.value, "States Info", "");
      }
    }
  </script>
