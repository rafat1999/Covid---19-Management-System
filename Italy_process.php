<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
     ...
     $cheak_duplicate_entry = "SELECT Country_Name FROM itali WHERE  Country_Name = '$Country_Name'";
     ...
     if(!$conn){
         ...
         $sql="INSERT INTO `itali` (`Country_Name`,`Effected_People`,`No_of_cured_people`,`Total_Numbers_of_Death`) VALUES ('$Country_Name','$Effected_People','$No_of_cured_people','$Total_Numbers_of_Death')";
